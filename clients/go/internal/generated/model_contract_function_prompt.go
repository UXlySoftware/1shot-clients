...
type ContractFunctionPrompt struct {
	...
	Inputs []ContractFunctionParamPrompt `json:"inputs"`
	// An array of output parameters for the function. Outputs are not required to be named in Solidity, but do require a name in 1Shot.
	Outputs []ContractFunctionParamPrompt `json:"outputs"`
}
