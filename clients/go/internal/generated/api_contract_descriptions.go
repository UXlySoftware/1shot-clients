...
type ContractDescriptionsApiService service
/*
ContractDescriptionsApiService
...
*/
func (a *ContractDescriptionsApiService) ContractsDescriptionsSearchPost(ctx context.Context, body DescriptionsSearchBody) ([]FullContractDescription, *http.Response, error) {
	var (
