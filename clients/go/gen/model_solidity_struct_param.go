...
// A single defined parameter for a Solidity Struct after it has been created. Contract Methods create an anonymous Solidiy Struct for the inputs and outputs, so a SolidityStructParam can be thought of as a parameter for a Contract Method. It corresponds to an item in an ABI.
type SolidityStructParam struct {
	...
	Type_       *ESolidityAbiParameterType `json:"type"`
	...
	TypeStruct   *SolidityStruct `json:"typeStruct,omitempty"`
}
