...
/*
AuthenticationApiService Obtain an OAuth2 access token
...
*/
func (a *AuthenticationApiService) GetAccessToken(ctx context.Context, grantType string, clientId string, clientSecret string) (InlineResponse200, *http.Response, error) {
	var (
