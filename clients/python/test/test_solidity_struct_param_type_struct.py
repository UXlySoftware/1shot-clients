...
class TestSolidityStructParamTypeStruct(unittest.TestCase):
    """SolidityStructParamTypeStruct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SolidityStructParamTypeStruct:
        """Test SolidityStructParamTypeStruct
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SolidityStructParamTypeStruct`
        """
        model = SolidityStructParamTypeStruct()
        if include_optional:
            return SolidityStructParamTypeStruct(
    ...
    def testSolidityStructParamTypeStruct(self):
        """Test SolidityStructParamTypeStruct"""
