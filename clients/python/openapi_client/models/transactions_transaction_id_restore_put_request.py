...
class TransactionsTransactionIdRestorePutRequest(BaseModel):
    """
    TransactionsTransactionIdRestorePutRequest
    """ # noqa: E501
    reward_ids: Optional[List[StrictStr]] = Field(default=None, alias="rewardIds")
    __properties: ClassVar[List[str]] = ["rewardIds"]
