...
class SolidityStructParamTypeStruct(BaseModel):
    """
    SolidityStructParamTypeStruct
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Internal ID of the struct.")
    business_id: Optional[StrictStr] = Field(default=None, description="Internal ID of the business that owns this struct", alias="businessId")
    name: Optional[StrictStr] = Field(default=None, description="The name of the struct. Structs are used to define the parameters of a transaction, but these structs don't have names.")
    ...
    __properties: ClassVar[List[str]] = ["id", "businessId", "name", "params", "deleted", "updated", "created"]
...
SolidityStructParamTypeStruct.model_rebuild(raise_errors=False)
