...
class BusinessBusinessIdTransactionsGet200Response(BaseModel):
    """
    ...
    response: Optional[List[Transaction]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response": [Transaction.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None
        })
        return _obj
