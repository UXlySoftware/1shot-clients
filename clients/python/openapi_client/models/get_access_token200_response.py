...
class GetAccessToken200Response(BaseModel):
    ...
    """ # noqa: E501
    access_token: Optional[StrictStr] = Field(default=None, description="The OAuth2 access token")
    token_type: Optional[StrictStr] = Field(default=None, description="Token type (always `Bearer`)")
    expires_in: Optional[StrictInt] = Field(default=None, description="Expiration time in seconds (usually 3600)")
    scope: Optional[StrictStr] = Field(default=None, description="Granted scopes")
    __properties: ClassVar[List[str]] = ["access_token", "token_type", "expires_in", "scope"]
