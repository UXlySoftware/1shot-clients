...
class AuthenticationApi:
    ...
    def get_access_token(
        self,
        grant_type: Annotated[Optional[StrictStr], Field(description="Must be `client_credentials`")] = None,
        client_id: Annotated[Optional[StrictStr], Field(description="A valid API Key value from a defined API Credential")] = None,
        client_secret: Annotated[Optional[StrictStr], Field(description="A valid Secret value from a defined API Credential")] = None,
        ...
        :param grant_type: Must be `client_credentials`
        :type grant_type: str
        :param client_id: A valid API Key value from a defined API Credential
        :type client_id: str
        :param client_secret: A valid Secret value from a defined API Credential
    ...
    def get_access_token_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAccessToken200Response]:
        """Obtain an OAuth2 access token
